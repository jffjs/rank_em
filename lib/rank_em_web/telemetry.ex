defmodule RankEmWeb.Telemetry do
  use Supervisor
  ...
  def metrics do
    [
      ...
      summary("rank_em.repo.query.total_time", unit: {:native, :millisecond}),
      summary("rank_em.repo.query.decode_time", unit: {:native, :millisecond}),
      summary("rank_em.repo.query.query_time", unit: {:native, :millisecond}),
      summary("rank_em.repo.query.queue_time", unit: {:native, :millisecond}),
      summary("rank_em.repo.query.idle_time", unit: {:native, :millisecond}),
